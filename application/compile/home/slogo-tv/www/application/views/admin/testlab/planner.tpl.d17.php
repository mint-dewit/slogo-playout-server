...
'';// checking for modification in file:/home/slogo-tv/www/application/views/admin/testlab/../layout.tpl
if (!("1424699891" == filemtime('/home/slogo-tv/www/application/views/admin/testlab/../layout.tpl'))) { ob_end_clean(); return false; };?><html>
<head>
...
$(document).ready(function() {
    ...
    $('.programme-select').change(function(){
        ...
        $('.episode-selector#' + id).css({'display':'inline-block'});
    });
