...
<?php echo form_submit('Opslaan', 'Opslaan');?><button type="button"><a href="<?php echo site_url();?>admin/programmering/delete?type=programma&redirect=admin/programmering&id=<?php echo $this->scope["programme_data"]["programme_id"];?>">Verwijder programma</a></button>
<?php echo form_close();?>
...
<div class="clear" style="height:10px;"></div>
<button type="button"><a href="<?php echo site_url();?>admin/programmering/<?php echo $this->scope["programme_data"]["programme_id"];?>/episode/new">Aflevering toevoegen</a></button>
